...
2. Using Obsidian Git plugin, changes are synchronized to a local git repository
3. The local repo is mirrored to an externally hosted repo 
4. The content is built into this website using Quartz v4
